...
export default function MetricsLog() {
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    try {
      // Create a list of promises for all API operations
      const promises = [];
      ...
      // PUT updates (run in parallel instead of sequentially)
      updates.forEach((u) => {
      ...
      if (promises.length > 0) {
        ...
        // Manually invalidate and refresh snapshot once after all operations complete
