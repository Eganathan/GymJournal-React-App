...
function ExerciseGroup({ exercise, sessionId, isCompleted: sessionCompleted }) {
  ...
  // ⚡ Bolt: Memoize best estimated 1RM calculation to prevent recalculating
  // on every tick of the parent elapsed timer.
...
export default function WorkoutActive() {
  ...
  // ⚡ Bolt: O(1) Maps for fast lookup in render list
            ...
            {exLoading ? (
              ...
              <div className="space-y-2">
                {exResults.map((ex) => {
                  ...
                  // ⚡ Bolt: Replace O(N) Array.find with O(1) Map.get
