...
function ExerciseGroup({ exercise, sessionId, isCompleted: sessionCompleted }) {
  ...
  // ⚡ Bolt: Memoized the reduction to prevent redundant calculations on every render, especially since this component re-renders frequently due to active timers.
