...
export default function AddExercise() {
  ...
  // ⚡ Bolt: Cache categories and equipment into Maps for O(1) lookups during render
  // This prevents O(n^2) performance degradation when scrolling large exercise lists
