...
export default function AddExercise() {
  ...
  // Optimization: Memoize categories and equipment as Maps for O(1) lookups during render.
  // This reduces the complexity of rendering the exercise list from O(N*M) to O(N + M).
