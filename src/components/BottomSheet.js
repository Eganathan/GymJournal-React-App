...
export default function BottomSheet({ open, onClose, title, children }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center animate-fade-in-fast">
      ...
      <div className="relative w-full max-w-lg rounded-t-3xl max-h-[85vh] flex flex-col animate-slide-up" style={{ backgroundColor: 'var(--bg-raised)', borderTop: '1px solid var(--border-default)' }}>
        {/* Handle bar */}
